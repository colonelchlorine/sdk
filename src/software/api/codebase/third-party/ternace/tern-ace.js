...
//BUGFIX
	  if (typeof(pos.row)!="undefined" && pos.row>=0) return {line: pos.row, ch: pos.column};
    return pos;
  }
...
define('ace/tern/tern_tooltip', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/range'], function(require, exports, module) {
  ...
  (function(){
      ...
      this.update = function() {
          ...
          var self = this;
          var tokenText = null;
          this.server.request(this.editor, {type: "type", types: true, origins: true, docs: true, urls: true}, function(error, data) {
            if (error) return;// showError(editor, error);
            if(data.type) {
              tokenText = '';
